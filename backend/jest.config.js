...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/qb/0t5lj0d125v23ww2tlsc7jc40000gn/T/jest_dx",
  ...
  // The test environment that will be used fr testing
  ...
  // testMatch: ['**/?(*.)+(db-spec|db-test).[tj]s?(x)'],
